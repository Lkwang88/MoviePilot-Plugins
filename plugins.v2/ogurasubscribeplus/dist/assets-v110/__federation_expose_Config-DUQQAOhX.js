...
const _hoisted_55 = { class: "sp-dashboard-section" };
const _hoisted_56 = { class: "sp-dashboard-title" };
...
async function loadOptions() {
  try {
    const [categoryResponse, siteResponse] = await Promise.all([
      props.api.get('plugin/OguraSubscribePlus/categories'),
      props.api.get('plugin/OguraSubscribePlus/sites'),
    ]);
...
async function loadData() {
  ...
  try {
    const [statusResponse, resultsResponse] = await Promise.all([
      props.api.get('plugin/OguraSubscribePlus/status'),
      props.api.get('plugin/OguraSubscribePlus/results'),
    ]);
...
async function runScan() {
  ...
  error.value = '';
  try {
    await props.api.post('plugin/OguraSubscribePlus/scan', {});
    await loadData();
  } catch (err) {
...
async function clearResults() {
  ...
  error.value = '';
  try {
    await props.api.post('plugin/OguraSubscribePlus/results/clear', {});
    await loadData();
  } catch (err) {
...
async function deleteResult(item) {
  ...
  error.value = '';
  try {
    await props.api.post('plugin/OguraSubscribePlus/results/delete', { result_id: item.result_id });
    await loadData();
  } catch (err) {
...
async function clearRuleRecords() {
  ...
  error.value = '';
  try {
    await props.api.post('plugin/OguraSubscribePlus/rule_records/clear', {});
    await loadData();
  } catch (err) {
...
async function clearIdentifierRecords() {
  ...
  try {
    await props.api.post('plugin/OguraSubscribePlus/identifier_records/clear', {});
...
async function deleteRuleRecord(record) {
  ...
  error.value = '';
  try {
    await props.api.post('plugin/OguraSubscribePlus/rule_records/delete', { record_id: record.record_id });
    await loadData();
  } catch (err) {
...
async function runIdentifierAction(action) {
  ...
  try {
    ...
    const response = await props.api.post(`plugin/OguraSubscribePlus/${endpoint}`, {
      title,
...
async function previewRule(item, candidate) {
  ...
  try {
    const response = await props.api.post('plugin/OguraSubscribePlus/rule_suggestions', {
      diagnosis: item,
      candidate,
    });
    const body = response?.data ?? response ?? {};
...
async function previewRuleSuggestion(suggestion) {
  ...
  try {
    const response = await props.api.post('plugin/OguraSubscribePlus/rule_preview', {
...
async function confirmRule() {
  ...
  try {
    await props.api.post('plugin/OguraSubscribePlus/rule_confirm', { token: preview.value.token });
...
async function saveConfig() {
  ...
  try {
    if (typeof props.api?.post === 'function') {
      const response = await props.api.post('plugin/OguraSubscribePlus/config', payload);
      const body = response?.data ?? response ?? {};
      const data = body?.data ?? body;
      if (body.success === false || data.success === false) {
      ...
      const verifyResponse = await props.api.get('plugin/OguraSubscribePlus/config');
              ...
              _createElementVNode("div", _hoisted_14, [
                _withDirectives(_createElementVNode("div", _hoisted_15, [
                  _createElementVNode("div", _hoisted_16, [
                    _cache[19] || (_cache[19] = _createElementVNode("div", { class: "sp-section-title mb-0" }, "运行概览", -1)),
                  ...
                  _createElementVNode("div", _hoisted_17, [
                    _createElementVNode("div", _hoisted_18, [
                      _createElementVNode("div", _hoisted_19, [
                        ...
                        _cache[20] || (_cache[20] = _createElementVNode("div", { class: "text-caption text-medium-emphasis" }, "最近扫描", -1))
                      ]),
                    ...
                    _createElementVNode("div", _hoisted_21, [
                      _createElementVNode("div", _hoisted_22, [
                        ...
                        _cache[21] || (_cache[21] = _createElementVNode("div", { class: "text-caption text-medium-emphasis" }, "待处理", -1))
                      ]),
                    ...
                    _createElementVNode("div", _hoisted_24, [
                      _createElementVNode("div", _hoisted_25, [
                        ...
                        _cache[22] || (_cache[22] = _createElementVNode("div", { class: "text-caption text-medium-emphasis" }, "可下载", -1))
                      ]),
                    ...
                    _createElementVNode("div", _hoisted_27, [
                      _createElementVNode("div", _hoisted_28, [
                        ...
                        _cache[23] || (_cache[23] = _createElementVNode("div", { class: "text-caption text-medium-emphasis" }, "规则修改", -1))
                      ]),
                ...
                _withDirectives(_createElementVNode("div", _hoisted_38, [
                  _createElementVNode("div", _hoisted_39, [
                    _cache[26] || (_cache[26] = _createElementVNode("div", { class: "sp-section-title mb-0" }, "自定义识别词", -1)),
                    _createVNode(_component_VSpacer),
                    _createVNode(_component_VChip, {
                      size: "small",
                      variant: "tonal"
                            ...
                            return (_openBlock(), _createElementBlock("div", {
                              ...
                              _createElementVNode("div", {
                                ...
                                (field.type === 'switch')
                                  ...
                                  : (field.type === 'time-list')
                                    ? (_openBlock(), _createElementBlock("div", _hoisted_53, [
                                        (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(config.scan_times, (scanTime, index) => {
                                          return (_openBlock(), _createElementBlock("div", {
                                            key: index,
                                            class: "sp-time-item"
                                          }, [
                                            _createVNode(_component_VTextField, {
                                              modelValue: config.scan_times[index],
                                              "onUpdate:modelValue": $event => ((config.scan_times[index]) = $event),
                                              type: "time",
                                              variant: "outlined",
                                              density: "compact",
                                              "hide-details": "",
                                            ...
                                            _createVNode(_component_VBtn, {
                                              ...
                                              variant: "text",
                                              size: "small",
                                              disabled: config.scan_times.length <= 1,
                                              onClick: $event => (removeScanTime(index))
                                        ...
                                        _createVNode(_component_VBtn, {
                                          ...
                                          disabled: config.scan_times.length >= 8,
                                          onClick: addScanTime
                                        }, {
                                          default: _withCtx(() => [...(_cache[31] || (_cache[31] = [
                                            _createTextVNode("添加时刻", -1)
                                          ]))]),
                                          _: 1
                                        }, 8, ["disabled"])
                                      ]))
                                    : (field.type === 'number')
                                      ...
                                      : (field.type === 'text')
                                        ? (_openBlock(), _createBlock(_component_VTextField, {
                                            ...
                                            "hide-details": "auto",
                                            rounded: "lg",
                                            "error-messages": field.validate === 'cron' ? _ctx.cronError : ''
              ...
              _createElementVNode("aside", _hoisted_54, [
                _createElementVNode("section", _hoisted_55, [
                  _createElementVNode("div", _hoisted_56, [
                    ...
                    _cache[32] || (_cache[32] = _createTextVNode("运行节奏", -1))
                  ]),
                  _createElementVNode("div", _hoisted_57, [
                    _createVNode(_component_VIcon, { icon: "mdi-calendar-sync-outline" }),
                    _cache[33] || (_cache[33] = _createElementVNode("span", null, "定时扫描", -1)),
                  ...
                  _createElementVNode("div", _hoisted_58, [
                    ...
                    _cache[34] || (_cache[34] = _createElementVNode("span", null, "超期检测", -1)),
                  ...
                  _createElementVNode("div", _hoisted_59, [
                    ...
                    _cache[35] || (_cache[35] = _createElementVNode("span", null, "通知方式", -1)),
                    _cache[36] || (_cache[36] = _createElementVNode("strong", null, "队列逐条", -1))
                  ]),
                  _createElementVNode("div", _hoisted_60, [
                    _createVNode(_component_VIcon, { icon: "mdi-database-clock-outline" }),
                    _cache[37] || (_cache[37] = _createElementVNode("span", null, "候选缓存", -1)),
                ...
                _createElementVNode("section", _hoisted_61, [
                  _createElementVNode("div", _hoisted_62, [
                    ...
                    _cache[38] || (_cache[38] = _createTextVNode("运行概况", -1))
                  ]),
                  _createElementVNode("div", _hoisted_63, [
                    _createVNode(_component_VIcon, { icon: "mdi-history" }),
                    _cache[39] || (_cache[39] = _createElementVNode("span", null, "最近扫描", -1)),
                  ...
                  _createElementVNode("div", _hoisted_64, [
                    ...
                    _cache[40] || (_cache[40] = _createElementVNode("span", null, "待处理", -1)),
                  ...
                  _createElementVNode("div", _hoisted_65, [
                    ...
                    _cache[41] || (_cache[41] = _createElementVNode("span", null, "候选资源", -1)),
                  ...
                  _createElementVNode("div", _hoisted_66, [
                    ...
                    _cache[42] || (_cache[42] = _createElementVNode("span", null, "已启用功能", -1)),
              ...
              default: _withCtx(() => [
                ...
                (ruleSuggestions.value.length && !preview.value)
                  ? (_openBlock(), _createElementBlock("div", _hoisted_67, [
                      _cache[45] || (_cache[45] = _createElementVNode("div", { class: "text-caption text-medium-emphasis mb-2" }, "请选择要添加的官组、平台关键词或 PT 站点", -1)),
                ...
                (preview.value)
                  ? (_openBlock(), _createElementBlock("div", _hoisted_68, [
                      (preview.value.selected_text)
                        ? (_openBlock(), _createElementBlock("div", _hoisted_69, "已选择：" + _toDisplayString(preview.value.selected_text), 1))
                        : _createCommentVNode("", true),
...
const Config = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-3fed23fa"]]);

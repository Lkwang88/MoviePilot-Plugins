...
from ogurasubscribeplus.models import DiagnosisInput, DiagnosisItem, PluginConfig, StaleEpisode
...
class FakeStore:
    ...
    def load_scan_cursor(self):
        return 0

    def save_scan_cursor(self, _cursor):
        pass
